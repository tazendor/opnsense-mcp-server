...
# VPN / proxy / captive-portal domains, each of which exposes the same
# {module}/service/{action} lifecycle controller.
...
def register_tools(mcp: FastMCP, client: OPNsenseClient) -> None:
    ...
    async def service_status(module: str) -> dict[str, Any]:
        ...
        Supported modules: unbound, kea, ids, openvpn, ipsec,
        wireguard, proxy, captiveportal."""
